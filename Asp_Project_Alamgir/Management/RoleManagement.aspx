<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainAdmin/MainMaster.Master" AutoEventWireup="true" CodeBehind="RoleManagement.aspx.cs" Inherits="Asp_Project_Alamgir.Management.RoleManagement" %>
    ...
    <div class="row">
        <div class="col-sm-12 table-responsive">
            ...
            <asp:GridView ID="grdUsers" runat="server" DataKeyNames="Id"
                ...
                ItemType="Asp_Project_Alamgir.Models.ApplicationUser" 
